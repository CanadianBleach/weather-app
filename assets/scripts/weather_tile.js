...
export default class WeatherTile extends HTMLElement {
	constructor(day) {
		...
		// Min and max temps from kelvin
		let min = Math.round((day.main.temp_min - 273.15) * 9 / 5 + 32);
		let max = Math.round((day.main.temp_max - 273.15) * 9 / 5 + 32);
